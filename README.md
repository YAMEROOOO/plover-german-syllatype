...
- [Delta's German Stenography](#deltas-german-stenography)
  ...
  - [Dictionary Formats](#dictionary-formats)
    - [DSD Dictionaries](#dsd-dictionaries)
    - [DWD Dictionaries](#dwd-dictionaries)
  - [TLDR](#tldr)
      - [Layout](#layout)
...
First and foremost, I would like to thank [Kathy](https://github.com/Kaoffie) for creating this plugin for me. Without her constant help and quick implementation of changes to the plugin, I wouldn't have been able to create this theory in the first place. Furthermore, I want to thank the people on the plover discord that helped me out weren't annoyed of my constant questionings regarding steno topics. 
